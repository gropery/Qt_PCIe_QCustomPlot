...
HD_PWD='C:/Users/Administrator/Desktop/Pcie/14_PCIe_test/PCIe_test.runs/design_1_util_ds_buf_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_util_ds_buf_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_util_ds_buf_0_1.tcl
